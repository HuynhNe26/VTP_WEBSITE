      ...
      <div className="cart-container">
        ...
        {qrCodeUrl ? (
          <div className="qr-section">
            ...
            />
            <p>Vui lòng chuyển khoản với cú pháp: <strong>{userInfo?.phone || 'SDT'}</strong></p>
            <p>Tổng tiền: <strong>{checkoutTotal.toLocaleString('vi-VN')} VND</strong></p>
            <p style={{ color: '#e67e22' }}>Đang chuyển hướng đến lịch sử đơn hàng...</p>
          </div>
        ) : showCheckoutConfirm ? (
          <div className="checkout-confirm">
            ...
            {userInfo && (
              <div className="user-info">
                ...
                <p><strong>Tên người dùng:</strong> {userInfo.username || 'N/A'}</p>
