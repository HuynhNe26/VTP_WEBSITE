...
import ManageOrderAll from '../admin/order/mangae_order_all.js';
import SearchPage from '../admin/navbar/search.js';
import Statistics from '../admin/Statistics/Statistics.js'
import InfoUserAdmin from '../admin/user/info_user.js';
import Description from '../admin/product/description.js';
...
import ForgetPassword from '../view/login/forget_password.js';
        ...
        <BrowserRouter>
            <Routes>
                <Route path="/" element={<Navbar />}>
                    ...
                    <Route path="/category/:selectedCategory/classify/:selectedClassify/product/:selectedProduct" element={<Product />} />
                ...
                <Route path="/admin" element={<NavbarAdmin />}>
                    ...
                    <Route path="manage_product/description/:id" element={<Description />} />
                    <Route path="manage_user" element={<Manage_User />} />
                    <Route path="manage_user/:id" element={<InfoUserAdmin />} />
                    ...
                    <Route path="manage_order_all" element={<ManageOrderAll />}/>
